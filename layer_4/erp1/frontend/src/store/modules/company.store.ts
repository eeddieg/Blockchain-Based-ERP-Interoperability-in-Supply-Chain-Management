...
export default class CompanyStoreModule extends VuexModule {
  private layer = "L4";
  private company = {
    name: this.layer + "-" + "Company_A",
    email: String(this.layer).toLowerCase() + "." + "l4.compA@test.com",
    phone: "(239) 815-8918",
    mobile: "(239) 815-1898",
    address: "Bay Area, San Francisco, CA",
    reservedResources: 0,
    availableResources: 0,
    productToBuy: ProductBc.WHEAT_SACK_PALLETE_PRE,
    productToSell: ProductBc.WHEAT_SACK_PALLETE_POST,
  } as Company;

  get getCompanyLayer(): string {
    return this.layer;
  }
