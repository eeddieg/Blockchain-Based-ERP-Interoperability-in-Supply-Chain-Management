...
const Customers: Prisma.CustomerCreateInput[] = [
  {
    name: "L4CA_Customer 1",
    email: "l4ca_cust1@test.com",
  },
  {
    name: "L4CA_Customer 2",
    email: "l4ca_cust2@test.com",
  },
  {
    name: "L4CA_Customer 3",
    email: "l4ca_cust3@test.com",
  },
];
  ...
  for (const cust of Customers) {
    ...
    const resourcesCreated = await db.resource.create({
      data: {
        ...
        title: Product.WHEAT_SACK_PALLETE_PRE,
        amount: 1000,
      }
    });
...
async function addToCustomer(id: number, amount: number, type: OrderType) {
  ...
  console.log(`New order created from ${amount} untis of ${Product.WHEAT_SACK_PALLETE_PRE}`);
