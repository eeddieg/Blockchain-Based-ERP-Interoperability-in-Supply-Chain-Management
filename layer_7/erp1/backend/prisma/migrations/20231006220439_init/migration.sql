...
CREATE TABLE `Resource` (
    ...
    `title` ENUM('WHEAT_SEED', 'WHEAT', 'WHEAT_SACK', 'WHEAT_SACK_PALLETE_PRE', 'WHEAT_SACK_PALLETE_POST', 'FLOUR', 'BREAD_PRODUCT', 'DISTRIBUTED_BREAD_PRODUCT', 'BREAD_PRODUCT_CONSUMER') NOT NULL DEFAULT 'BREAD_PRODUCT',
