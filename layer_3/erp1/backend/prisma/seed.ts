...
const Customers: Prisma.CustomerCreateInput[] = [
  {
    name: "L3CA_Customer 1",
    email: "l3ca_cust1@test.com",
  },
  {
    name: "L3CA_Customer 2",
    email: "l3ca_cust2@test.com",
  },
  {
    name: "L3CA_Customer 3",
    email: "l3ca_cust3@test.com",
  },
];
...
async function addToCustomer(id: number, amount: number, type: OrderType) {
  ...
  console.log(`New order created from ${amount} untis of ${Product.WHEAT_SACK}`);
