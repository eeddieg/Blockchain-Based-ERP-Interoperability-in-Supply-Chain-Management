import { destroyToken } from './../../../../layer_7/erp1/frontend/src/services/api/jwt.service';
...
const Customers: Prisma.CustomerCreateInput[] = [
  {
    name: "L8CA_Customer 1",
    email: "l8ca_cust1@test.com",
  },
  {
    name: "L8A_Customer 2",
    email: "l8ca_cust2@test.com",
  },
  {
    name: "L8CA_Customer 3",
    email: "l8ca_cust3@test.com",
  },
];
  ...
  for (const cust of Customers) {
    ...
    const resourcesCreated = await db.resource.create({
      data: {
        ...
        title: Product.DISTRIBUTED_BREAD_PRODUCT,
        amount: 1000,
      }
    });
...
async function addToCustomer(id: number, amount: number, type: OrderType) {
  ...
  console.log(`New order created from ${amount} untis of ${Product.DISTRIBUTED_BREAD_PRODUCT}`);
