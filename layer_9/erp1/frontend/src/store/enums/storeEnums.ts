enum Actions {
  ...
  GET_PEDIGREE_BY_ID_FROM_BC = "getPedigreeByIdFromBc",
  ...
  GET_STAKEHOLDER_FROM_BC = "getStakeholderFromBc",
  ...
  INDUCE_DELAY = "sleep",
  LISTEN_FOR_UPDATED_TOKEN_EVENT = "listenForUpdatedToken",
  ...
  REMOVE_UPDATED_TOKEN_FILE_FROM_BC = "removeUpdatedTokenFile",
  ...
  UPDATE_TRACE_TOKEN_INFO_ON_BC = "updateTokenInfoOnBc",
...
enum Mutations {
  ...
  SET_COMPOSITE_PEDIGREE_TOKEN = "setCompositePedigreeToken",
  SET_ELEMENTAL_PEDIGREE_TOKEN = "setElementalPedigreeToken",
  ...
  UNSET_COMPOSITE_PEDIGREE_TOKEN = "clearCompositePedigreeToken",
  UNSET_ELEMENTAL_PEDIGREE_TOKEN = "clearElementalPedigreeToken",
