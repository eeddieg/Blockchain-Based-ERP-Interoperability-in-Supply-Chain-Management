...
const Customers: Prisma.CustomerCreateInput[] = [
  {
    name: "CA_Customer 1",
    email: "ca_cust1@test.com",
  },
  {
    name: "CA_Customer 2",
    email: "ca_cust2@test.com",
  },
  {
    name: "CA_Customer 3",
    email: "ca_cust3@test.com",
  },
  {
    name: "CA_Customer 4",
    email: "ca_cust4@test.com",
  },
  {
    name: "CA_Customer 5",
    email: "ca_cust5@test.com",
  }
];
...
async function addToCustomer(id: number, amount: number, type: OrderType) {
  ...
  console.log(`New order created from ${amount} untis of ${Product.WHEAT_SEED}`);
