...
orderRouter.get("/inventory/:id", authMiddleware.verify, OrderController.getCustomerInventory);
orderRouter.get("/getTraceToken", authMiddleware.verify, OrderController.getTraceTokenByOrderId);
...
orderRouter.post("/storeOrder", authMiddleware.verify, OrderController.storeOrderToDb);
orderRouter.post("/storeResources", authMiddleware.verify, OrderController.storeResourcesToDb);
